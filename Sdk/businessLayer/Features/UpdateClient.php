...
class UpdateClient extends Feature
{
    /**
     ...
     * debug files will created with section UpdateClient in config file and Attributes 
    ...
    {
        parent::__construct('UpdateClient', $configParams, $paymentManager);
    }
}
