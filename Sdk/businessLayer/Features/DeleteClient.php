...
class DeleteClient extends Feature
{
    /**
     ...
     * debug files will created with section DeleteClient in config file and Attributes 
    ...
    {
        parent::__construct('DeleteClient', $configParams, $paymentManager);
    }
}
