...
class SetClient extends Feature
{
    /**
     ...
     * debug files will created with section SeteClient in config file and Attributes 
    ...
    {
        parent::__construct('SetClient', $configParams, $paymentManager);
    }
}
