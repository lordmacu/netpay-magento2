...
class GetWebhook extends Feature
{
    /**
     ...
     * debug files will created with section GetWebhook in config file and Attributes 
    ...
    {
        parent::__construct('GetWebhook', $configParams, $paymentManager);
    }
}
