...
class GetClient extends Feature
{
    /**
     ...
     * debug files will created with section GetClient in config file and Attributes 
    ...
    {
        parent::__construct('GetClient', $configParams, $paymentManager);
    }
}
