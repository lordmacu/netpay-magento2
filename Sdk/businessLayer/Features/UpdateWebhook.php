...
class UpdateWebhook extends Feature
{
    /**
     ...
     * debug files will created with section UpdateWebhook in config file and Attributes 
    ...
    {
        parent::__construct('UpdateWebhook', $configParams, $paymentManager);
    }
}